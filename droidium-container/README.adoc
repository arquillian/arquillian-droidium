...
While inspecting the code, it is handy to have https://raw.github.com/smiklosovic/arquillian-thesis/master/resources/container-shutdown-droidium.png[container startup] and 
