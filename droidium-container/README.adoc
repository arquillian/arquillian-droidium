...
be able to start some Android container successfully.
...
your backend application into JBoss AS container and you test it on your mobile phone (emulator or physical device).

== How to prepare emulator for testing?

In general, you can test against physical device or emulator. Regarding of emulator, there are some useful tips how to 
speed your testing experience.

First of all, try to use emulator which uses x86 as ABI. When you do not need to test particularly against some ABI, consider 
...
You can experiment with other developer options according to your preferences.

Additionally, consider turning off all sound effects in Settings - Sound when you do not need them. There is +-noaudio+ switch for +emulator+ 
