...
Sets your API level you want to use when you are going to create emulator from scratch.

----
<configuration>
    <property name="apiLevel">18</property>
</configuration>
----
...
_Be sure that console port differs from adb port only by one and both ports are in that range otherwise 
adb can have difficulties to find the emulator._
