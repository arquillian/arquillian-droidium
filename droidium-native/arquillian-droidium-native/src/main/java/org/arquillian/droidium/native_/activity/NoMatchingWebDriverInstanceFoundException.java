...
public class NoMatchingWebDriverInstanceFoundException extends RuntimeException {
     ...
     * @param message
     */
    public NoMatchingWebDriverInstanceFoundException(String message) {
        super(message);
    }
     ...
     * @param cause
     */
    public NoMatchingWebDriverInstanceFoundException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause
     */
    public NoMatchingWebDriverInstanceFoundException(String message, Throwable cause) {
        super(message, cause);
    }
