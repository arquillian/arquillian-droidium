...
public class InvalidSelendroidPortException extends RuntimeException {
     ...
     * @param message
     */
    public InvalidSelendroidPortException(String message) {
        super(message);
    }
     ...
     * @param cause
     */
    public InvalidSelendroidPortException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause
     */
    public InvalidSelendroidPortException(String message, Throwable cause) {
        super(message, cause);
    }
