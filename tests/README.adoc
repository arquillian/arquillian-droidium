...
*Selendroid server and Selendroid testing applicatins APKs are located in this 
directory. Please copy them to the root directory of each project when applicable 
