...
/**
 * Installator of Android Selenium server to Android device, physical or virtual.
 * Sets port forwarding afterwards, by default from port 14444 to 8080 at device side.
 *
 * <br></br>
 * Observes:
 * <ul>
 ...
 * Fires:
 * <ul>
 * <li>{@link AndroidWebDriverInstalled}</li>
 * </ul>
 *
 * @author <a href="kpiwko@redhat.com">Karel Piwko</a>
 * @author <a href="smikloso@redhat.com">Stefan Miklosovic</a>
 */
public class AndroidWebDriverInstaller {

    private static final Logger log = Logger.getLogger(AndroidWebDriverInstaller.class.getName());
    ...
    @Inject
    private Event<AndroidWebDriverInstalled> androidWebDriverInstalled;
    ...
    public void install(@Observes AndroidDeviceReady event) throws AndroidExecutionException, IOException {
        ...
        androidWebDriverInstalled.fire(new AndroidWebDriverInstalled());
    }
