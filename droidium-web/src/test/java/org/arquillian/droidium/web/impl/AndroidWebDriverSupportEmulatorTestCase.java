...
import org.arquillian.droidium.web.event.AndroidWebDriverInstalled;
 ...
 * You can specify name and console port of already started emulator by sysem properties 
...
public class AndroidWebDriverSupportEmulatorTestCase extends AbstractAndroidTestTestBase {
    ...
    protected void addExtensions(List<Class<?>> extensions) {
        ...
        extensions.add(AndroidWebDriverInstaller.class);
        extensions.add(AndroidWebDriverUninstaller.class);
    }
    ...
    public void setup() {
        ...
        ArquillianDescriptor desc = Descriptors.create(ArquillianDescriptor.class)
            .extension("droidium-web").property("androidServerApk", ANDROID_SERVER_APK_PATH);
    ...
    public void testInstallUninstallAndroidWebDriverServer() {
        ...
        assertEventFired(AndroidWebDriverInstalled.class, 1);
        assertEventFired(AndroidWebDriverUninstalled.class, 1);
        ...
        assertEventFiredInContext(AndroidWebDriverInstalled.class, ContainerContext.class);
        assertEventFiredInContext(AndroidWebDriverUninstalled.class, ContainerContext.class);
