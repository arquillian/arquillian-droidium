...
echo no | android create avd -n $TEST_EMULATOR_NAME -t $TEST_EMULATOR_PLATFORM -f -p $WORKSPACE/$TEST_EMULATOR_NAME-emulator -c $TEST_EMULATOR_MEMORY --abi $TEST_EMULATOR_ABI
